...
const schema = {
  name: {
    ...
    required: true,
    trim: true,
    description: 'Name of Mobilizer'
  },
  organization: {
    type: String,
    trim: true,
    description: 'Name of Organization mobilizer is involved with'
  },
  wallet_address: {
    type: String,
    required: true,
  ...
  govt_id_image: {
    type: String,
    joi: Joi.string().uri().optional().description('Mobilizer government issued ID image url')
  },
...
const mobilizerSchema = mongoose.Schema(schema, {
