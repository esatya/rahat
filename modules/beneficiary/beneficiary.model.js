...
const schema = {
  ...
  wallet_address: {
    type: String, trim: true, joi: Joi.string().optional().description('Beneficiary wallet address'),
  },
  ...
  govt_id_image: { type: String, joi: Joi.string().optional().description('Beneficiary government issued ID image url') },
