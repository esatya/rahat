...
const schema = {
  name: {
    type: String, required: true, trim: true, description: 'Name of institution',
  },
  address: {
    type: String, description: 'Address of institution',
  },
  phone: {
    type: String, description: 'Phone of institution',
  },
  status: {
    type: String,
    required: true,
