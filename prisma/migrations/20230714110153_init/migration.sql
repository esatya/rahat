...
CREATE TABLE "Beneficiary" (
    ...
    "address" JSONB,
    "tokensAssigned" INTEGER DEFAULT 0,
    "tokensClaimed" INTEGER DEFAULT 0,
    "bankStatus" "BankStatus" DEFAULT 'UNKNOWN',
    "phoneStatus" "PhoneOwnership" DEFAULT 'UNKNOWN',
    "internetStatus" "InternetAccess" DEFAULT 'UNKNOWN',
